...
from .views import signup, profile_view, edit_profile, BlogCreateView, BlogListView, BlogDetailView, BlogUpdateView, BlogDeleteView, CommentCreateView,CommentUpdateView, CommentDeleteView, PostByTagListView, PostSearchView
